      ...
      <div class="grid col-start-1 col-span-6 ">
        <form action="{{ route('posts.searchDate') }}" method="get" class="grid grid-cols-6">
          <div class="col-start-1 col-end-2 mb-2">
            ...
            <input type="date" name="startDate" id="startDate" class="h-10 bg-white border border-gray-300 rounded py-2 px-2 text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0">
          </div>
          <div class="col-start-3 col-span-2 mb-2">
            <label for="text">End Date</label><br>
            <input type="date" name="endDate" id="endDate" class="h-10 bg-white border border-gray-300 rounded py-2 px-2 text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0">
          </div>
      ...
      <div class="col-start-8 col-span-4 pt-4">
        <form action="{{ route('posts.searchColumn') }}" method="GET">
          <div class="search mb-2">
            <input type="search" class="h-10 bg-white border border-gray-300 rounded py-2 px-2 text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0 mt-2" id="search" name="search" placeholder="Search by column name">
